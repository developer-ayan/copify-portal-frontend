...
import { BsBuildingsFill, BsFillFileEarmarkCheckFill, BsPersonBadgeFill } from "react-icons/bs";
...
export const navLinks = [
  ...
  {
    icon: <BiSolidPackage className="-ml-0.5 text-xl" title="Education Institute" />,
    id: 2,
  ...
  {
    icon: <BiSolidPackage className="-ml-0.5 text-xl" 
