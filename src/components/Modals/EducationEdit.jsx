...
const EditInstituteModal = ({
  ...
  const [location, setLocation] = useState(
    currentInstitute?.institute_location || ""
  );
  const [fileName, setFileName] = useState(currentInstitute?.file_upload || "");
  const [code, setCode] = useState(currentInstitute?.institute_code || "");
  const [file, setFile] = useState(null);

  const handleSave = () => {
    onSave(currentInstitute.institute_name, name, location, file, code);
  };
