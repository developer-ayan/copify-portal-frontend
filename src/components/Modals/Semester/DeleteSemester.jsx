...
const DeleteSemesterModal = ({ delete_name, closeModal, confirmModal, isLoading }) => {
  return (
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center p-4">
      <div className="bg-white p-6  shadow-md w-full max-w-sm sm:max-w-md">
        ...
        <p className="text-center mb-6">Are you sure you want to delete Semester {delete_name}?</p>
