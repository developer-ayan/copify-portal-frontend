...
const Order = () => {
  ...
  const [uploads, setUploads] = useState([
    { name: 'CDK000457', date: 'Date & Time', status: 'F05', heading: 'Ready to PickUp' },
    { name: 'CDK000025', date: 'Date & Time', status: 'Generating', heading: 'Sorting' },
    { name: 'CDK001525', date: 'Date & Time', status: 'Generating', heading: 'Printing' },
  ]);
            ...
            <table className="min-w-full bg-white">
              <thead>
                <tr>
                  ...
                  <th className="px-4 py-2 border">Schedule to Published</th>
